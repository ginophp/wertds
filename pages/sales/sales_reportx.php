        ...
        <div id="listingmediaserver">
			...
			<div class="row" id="CollectorsTable">
					...
					<div class="panel-heading">Parameter</div>
						...
						<div class="panel-body">
							...
							<div class="col-sm-6">
									...
									<div class="form-group" style="margin-right:10px;">
										<label class="control-label">As of Due  Date: </label>
										<input name="due_date" class="form-control input-sm datepicker" placeholder="[123]" value ="" />
									</div>
							</div>
						</div>
						</form>
				...
				<div class="col-lg-12" style="padding-bottom:5px;">
					...
					<button class="btn btn-danger btn-xl" name="search_details">
						<span class="fa fa-search fa-fw"></span>
					...
					<button class="btn btn-danger btn-xl" name="search_nrdm">
						<span class="fa fa-search fa-fw"></span>
						 no of recruits / daily "SUMMARY"
					</button>
					<button class="btn btn-danger btn-xl" name="search_nrdm_details">
						<span class="fa fa-search fa-fw"></span>
						 no of recruits / daily "Details"
					</button>
					<button class="btn btn-danger btn-xl" name="search_sales_report">
						<span class="fa fa-search fa-fw"></span>
						 Sales Report
					</button>
					<button class="btn btn-danger btn-xl" name="search_top_sales_report">
						<span class="fa fa-search fa-fw"></span>
						 Top Sales Report
					</button>
					<button class="btn btn-danger btn-xl" name="search_due_dates">
						<span class="fa fa-search fa-fw"></span>
						 Due Date Report
					</button>
					<button class="btn btn-danger btn-xl" name="search_collection_report">
						<span class="fa fa-search fa-fw"></span>
						 daliy collection report
					</button>
				</div>
...
<script>
	$(function(){ 
		...
		$("[name=search]").click(function(){
			var serialize = $("[name=search_form_parameter]").serialize()+"&action=Pagination&page=1&Table=dailysalesreport";
				$.ajax({
					type	:	"post",
					url		:	"pages/hr/ajax/proccess.php",
					dataType:	"json",
		...
		$("[name=search_details]").click(function(){
			var serialize = $("[name=search_form_parameter]").serialize()+"&action=Pagination&page=1&Table=dailysalesreport_details";
				$.ajax({
					type	:	"post",
					url		:	"pages/hr/ajax/proccess.php",
					dataType:	"json",
		...
		$("[name=search_ssm]").click(function(){
			var serialize = $("[name=search_form_parameter]").serialize()+"&action=Pagination&page=1&Table=si_stock_movement";
				$.ajax({
					type	:	"post",
					url		:	"pages/hr/ajax/proccess.php",
					dataType:	"json",
